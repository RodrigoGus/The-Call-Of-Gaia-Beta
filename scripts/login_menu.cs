...
//     private string connectionString = "Server=tcog_db.mysql.dbaas.com.br;Database=tcog_db;Uid=tcog_db;Pwd=tcogdb@T1";
...
//     {
//         _nicknameTextbox = GetNode<TextEdit>("NicknameTextbox");
//         _emailTextbox = GetNode<TextEdit>("EmailTextbox");
//         _passwordTextbox = GetNode<TextEdit>("PasswordTextbox");        
